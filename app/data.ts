...
export const projects: {
...
}[] = [
	{
		...
		description:
			"AI Powered translator, like Google Translate, but with more features.",
		tecnologies: [
			"Next.js",
			"TypeScript",
			"AI-SDK",
	...
	},
	{
		...
		urlDemo:
			"https://stellar-burgers-git-main-mi-viejo-amigos-projects.vercel.app/",
	},
	{
...
export const interests = [
	{
		name: "Ethical Coding",
		description:
			"Committed to developing software with ethical considerations",
		bgClass:
	...
	},
	{
		...
		bgClass:
			"bg-indigo-100 hover:bg-indigo-200 dark:bg-indigo-900/30 dark:hover:bg-indigo-800/40",
	},
	{
		name: "Traveling",
		description: "Discovering new places and cultures",
		bgClass:
			"bg-purple-100 hover:bg-purple-200 dark:bg-purple-900/30 dark:hover:bg-purple-800/40",
	},
	{
		name: "Diving",
...
export const techStack = [
	...
	},
	{
		...
		bgClass:
			"bg-orange-100 hover:bg-orange-200 dark:bg-orange-900/30 dark:hover:bg-orange-800/40",
	},
	{
		name: "MCP",
	...
	},
	{
		name: "Testing",
		description:
			"Ensuring code quality through automated testing with Jest and Cypress",
		bgClass:
			"bg-purple-100 hover:bg-purple-200 dark:bg-purple-900/30 dark:hover:bg-purple-800/40",
	},
];
...
export const aboutContent = {
	shortBio:
		"Frontend developer with experience in creating modern web applications and a passion for building intuitive and responsive user interfaces.",
	approach:
...
export const characterTraits = [
	...
	},
	{
		...
		description:
			"Breaking down complex problems into understandable components",
		icon: "chart-bar",
	...
	},
	{
		trait: "Team Player",
		description:
			"Working effectively in teams, valuing everyone's contribution",
		icon: "users",
		color: "text-blue-500",
	},
];
...
export const achievements: AchievementCardProps[] = [
	{
		...
		problem:
			"Slow initial page load and high LCP metrics affecting user experience and SEO ranking",
		solution:
			"Implemented code splitting, optimized asset loading, and utilized Next.js Image component with proper sizing",
	...
	},
	{
		...
		problem:
			"Confusing navigation and unintuitive interface leading to high bounce rates and low conversion",
		solution:
			"Conducted user research, implemented A/B testing, and redesigned the interface with a focus on intuitive user flows",
	...
	},
	{
		...
		problem:
			"Website was not accessible to users with disabilities, failing several WCAG requirements",
		solution:
			"Implemented semantic HTML, improved keyboard navigation, added ARIA attributes, and ensured proper color contrast",
	...
	},
	{
		...
		problem:
			"Legacy codebase with technical debt, inconsistencies, and redundant code",
		solution:
			"Systematically refactored code, implemented modern patterns, and removed unused dependencies",
	...
	},
	{
		...
		problem:
			"Poor user experience on mobile devices with non-responsive layouts and small touch targets",
		solution:
			"Implemented mobile-first approach, redesigned UI components, and improved touch interactions",
